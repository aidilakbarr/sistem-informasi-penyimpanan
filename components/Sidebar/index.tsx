...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const menuGroups = [
    {
      ...
      menuItems: [
        ...
        },
        {
          ...
          route: `/${params.idMahasiswa}/pemesanan`,
        },
        {
          icon: (
            <svg
        ...
        },
        {
          ...
          label: "Pembayaran",
          route: `/${params.idMahasiswa}/pembayaran`,
        },
        {
          icon: (
            <svg
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#4D55CC] duration-300 ease-linear lg:translate-x-0 dark:bg-black border-r-2 border- ${
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/" className="flex gap-4 items-center">
            ...
            />
            <h1 className=" text-3xl text-white">SIREMBA</h1>
          </Link>
          <button
